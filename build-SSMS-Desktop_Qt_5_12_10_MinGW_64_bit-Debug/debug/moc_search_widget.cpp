...
QT_MOC_LITERAL(4, 29, 23) // "on_returnButton_clicked"
    ...
    "SearchWidget\0display\0\0number\0"
...
void SearchWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (SearchWidget::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SearchWidget::display)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SearchWidget::display(int _t1)
{
