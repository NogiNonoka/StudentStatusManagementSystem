/****************************************************************************
** Meta object code from reading C++ file 'browser_widget.h'
**
...
#include "../../SSMS/browser_widget.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'browser_widget.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(4, 30, 23) // "on_returnButton_clicked"
    ...
    "BrowserWidget\0display\0\0number\0"
...
void BrowserWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (BrowserWidget::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BrowserWidget::display)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void BrowserWidget::display(int _t1)
{
